...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202209111048-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  entrypoint-headphones.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Sep 11, 2022 10:48 EDT
# @@File             :  entrypoint-headphones.sh
# @@Description      :
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Additional commands
[ -f "/config/headphones.ini" ] || cp -Rf "/etc/headphones.ini" "/config/headphones.ini"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
case "$1" in
--help) # Help message
...
*) # Execute primary command
  if [ $# -eq 0 ]; then
    python3 /var/lib/headphones/Headphones.py --daemon --config /config/headphones.ini --datadir /data/headphones --nolaunch
  else
    __exec_bash "/bin/bash"
  fi
  exitCode=$?
